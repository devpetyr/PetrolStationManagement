...
{{--                                    <img class="pattern-img" src="{{asset('superAdmin/images/pattern/pattern6.png')}}" alt="">--}}
{{--                                    <div class="card-info text-white">--}}
{{--                                        <img src="{{asset('superAdmin/images/pattern/circle.png')}}" class="mb-4" alt="">--}}
...
{{--                    <div class="card-body">--}}
{{--                        <div class="user-bx">--}}
{{--                            <img src="{{asset('superAdmin/images/profile/small/pic1.jpg')}}" alt="">--}}
{{--                            <div>--}}
...
{{--                        <ul class="user-list">--}}
{{--                            <li><img src="{{asset('superAdmin/images/avatar/1.jpg')}}" alt=""></li>--}}
{{--                            <li><img src="{{asset('superAdmin/images/avatar/2.jpg')}}" alt=""></li>--}}
{{--                            <li><img src="{{asset('superAdmin/images/avatar/3.jpg')}}" alt=""></li>--}}
{{--                            <li><img src="{{asset('superAdmin/images/avatar/4.jpg')}}" alt=""></li>--}}
{{--                            <li><img src="{{asset('superAdmin/images/avatar/5.jpg')}}" alt=""></li>--}}
{{--                            <li><img src="{{asset('superAdmin/images/avatar/6.jpg')}}" alt=""></li>--}}
{{--                        </ul>--}}
